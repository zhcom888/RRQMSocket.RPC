...
namespace RRQMSocket.RPC
{
    ...
    public static class CodeGenerator
    {
        ...
        public static string ConvertToCode(string @namespace, params ServerCellCode[] serverCodes)
        {
            ...
            codeString.AppendLine("using RRQMSocket.RPC.TouchRpc;");
        ...
        public static ServerCellCode Generator(Type serverType, Type attributeType)
        {
            ...
            foreach (var item in instances)
            {
                ...
                methodCellCode.InterfaceTemple = serverCodeGenerator.GetInterfaceProxy(item, (RpcAttribute)item.GetAttribute(attributeType));
                methodCellCode.CodeTemple = serverCodeGenerator.GetMethodProxy(item, (RpcAttribute)item.GetAttribute(attributeType));
                methodCellCode.ExtensionsTemple = serverCodeGenerator.GetExtensionsMethodProxy(item, (RpcAttribute)item.GetAttribute(attributeType));
        ...
        public static MethodInstance[] GetMethodInstances(Type serverType)
        {
            ...
            foreach (MethodInfo method in methodInfos)
            {
                ...
                if (attributes.Count() > 0)
                {
                    ...
                    methodInstance.RouteKey =$"{serverType.Name}/{method.Name}".ToLower();
