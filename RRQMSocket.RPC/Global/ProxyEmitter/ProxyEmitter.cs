...
namespace RRQMSocket.RPC.ProxyEmitter
{
    ...
    public static class ProxyEmitter
    {
        ...
        public static TInterface CreateProxy<TBase, TInterface>(params object[] args)where TBase : ProxyBase where TInterface : class
        {
        ...
        private static Type EmitProxyType(Type baseType, Type interfaceType)
        {
            ...
            var proxyType = tBuilder.CreateTypeInfo();
            return proxyType;
        }
