...
namespace RRQMSocket.RPC.TouchRpc
{
    public partial class RpcActor
    {
        ...
        /// 设置RpcService
        /// </summary>
        /// <param name="rpcCerter"></param>
        public void SetRpcStore(RpcStore rpcCerter)
        {
        ...
        {
            this.SocketSend(TouchRpcUtility.P_204_CancelInvoke, RRQMBitConverter.Default.GetBytes((long)obj));
        }
        ...
        WaitCallback m_waitCallback_InvokeClientByID;
        ...
        private void InvokeThis(object o)
        {
            ...
            if (this.m_rpcCerter.MethodMap.TryGet(context.methodName, out methodInstance))
            {
                try
                {
            ...
            {
                invokeResult = this.RpcStore.Execute(methodInstance, ps);
            }
